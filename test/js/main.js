...
$('.discount__slider').slick({
    ...
    slidesToScroll: 3,
    arrows: true,
	prevArrow: '<button type="button" class="slider-btn slider-btn__left"><img src="img/icons/prev-arrow.svg" alt=""></button>',
    nextArrow: '<button type="button" class="slider-btn slider-btn__right"><img src="img/icons/next-arrow.svg" alt=""></button>',
	responsive: [
		{
			breakpoint: 1500,
			settings: {
...
if ($(window).width() < 1200) {
	$('.news__content').slick({
		...
		slidesToScroll: 1,
		arrows: true,
		prevArrow: '<button type="button" class="slider-btn--news slider__btn-left--news"><img src="img/icons/left-arrow.svg" alt=""></button>',
		nextArrow: '<button type="button" class="slider-btn--news slider__btn-right--news"><img src="img/icons/right-arrow.svg" alt=""></button>',

	});
} else {
	$(".news__content").slick("unslick");
}
...
$(document).ready(function(){
	...
	if ($(window).width() < 900) {
		$('.insta__slider-mobile').slick({
			infinite: true,
			slidesToShow: 2,
			slidesToScroll: 1,
			arrows: true,
			prevArrow: '<button type="button" class="slider-btn--insta"><img src="img/icons/insta-arrow.svg" alt=""></button>',
    		nextArrow: false

		});
	} else {
		$(".insta__slider-mobile").slick("unslick");
	}
});